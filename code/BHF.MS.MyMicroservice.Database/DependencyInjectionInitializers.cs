using BHF.MS.test13.Database.Context;
using BHF.MS.test13.Database.Services;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using System.Diagnostics.CodeAnalysis;

namespace BHF.MS.test13.Database
{
    ...
    public static class DependencyInjectionInitializers
    {
        public static void AddDatabases(IServiceCollection serviceCollection)
        {
            ...
            {
                options.UseSqlServer("name=ConnectionStrings:Dbtest13");
            });
        }
